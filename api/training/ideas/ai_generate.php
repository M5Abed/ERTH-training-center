...
if ($aiResult['ok'] && is_array($aiResult['result'])) {
    ...
    respond([
        ...
        'proposal' => [
            'title_en'          => $p['title_en']          ?? "Smart System for " . ucwords($keywords),
            'title_ar'          => $p['title_ar']          ?? "نظام ذكي لـ " . $keywords,
...
respond([
    ...
    'proposal' => [
        'title_en'          => "Smart System for " . ucwords($keywords),
        'title_ar'          => "نظام ذكي لـ " . $keywords,
        'description_en'    => "This university summer training project focuses on building a full-stack web application tailored for $keywords. It includes user authentication, role-based access control, responsive dashboards, and automated report generation.",
        'description_ar'    => "يركز هذا المشروع التدريبي على بناء تطبيق ويب متكامل مخصص لـ $keywords. ويتضمن نظام توثيق للمستخدمين، وصلاحيات حسب الأدوار، ولوحات تحكم تفاعلية، وتوليد تقارير آلياً.",
