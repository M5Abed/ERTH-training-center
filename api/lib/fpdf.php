...
public function SetFont($family, $style='', $size=0)
{
	...
	if(!isset($this->fonts[$fontkey]))
	{
		...
		if(in_array($family, $this->CoreFonts))
		{
			...
			$fontkey = $family.$style;
			if(!isset($this->fonts[$fontkey]))
				$this->_loadcorefont($family, $style);
		}
		else
...
protected function _loadcorefont($font, $style)
{
	$fontkey = $font.$style;
	$this->fonts[$fontkey] = array('i'=>count($this->fonts)+1, 'type'=>'Core', 'name'=>$this->_getcorefontname($font,$style), 'cw'=>$this->_getcorefontcw($font,$style), 'subsetted'=>false);
}

protected function _getcorefontname($font, $style)
{
	if($font=='helvetica' || $font=='arial')
		$font = 'Helvetica';
	elseif($font=='times')
		$font = 'Times';
	elseif($font=='courier')
...
protected function _getcorefontcw($font, $style)
{
	static $cw = array(
		'Helvetica' => array(
		...
		'Helvetica-Bold' => array(
			...
			'0'=>556,'1'=>556,'2'=>556,'3'=>556,'4'=>556,'5'=>556,'6'=>556,'7'=>556,'8'=>556,'9'=>556,':'=>333,';'=>333,'<'=>584,'='=>584,'>'=>584,'?'=>556,
			'@'=>1015,'A'=>722,'B'=>722,'C'=>722,'D'=>722,'E'=>667,'F'=>611,'G'=>778,'H'=>778,'I'=>278,'J'=>556,'K'=>722,'L'=>611,'M'=>833,'N'=>722,'O'=>778,
			'P'=>667,'Q'=>778,'R'=>722,'S'=>667,'T'=>611,'U'=>778,'V'=>667,'W'=>944,'X'=>667,'Y'=>667,'Z'=>667,'['=>333,'\\'=>278,']'=>333,'^'=>584,'_'=>556,
			'`'=>333,'a'=>556,'b'=>611,'c'=>556,'d'=>611,'e'=>556,'f'=>333,'g'=>611,'h'=>611,'i'=>278,'j'=>278,'k'=>556,'l'=>278,'m'=>889,'n'=>611,'o'=>611,
			'p'=>611,'q'=>611,'r'=>389,'s'=>556,'t'=>333,'u'=>611,'v'=>556,'w'=>778,'x'=>556,'y'=>556,'z'=>500,'{'=>389,'|'=>280,'}'=>389,'~'=>584
		),
		'Helvetica-Oblique' => array(
			' '=>278,'!'=>278,'"'=>355,'#'=>556,'$'=>556,'%'=>889,'&'=>667,'\''=>191,'('=>333,')'=>333,'*'=>389,'+'=>584,','=>278,'-'=>333,'.'=>278,'/'=>278,
			'0'=>556,'1'=>556,'2'=>556,'3'=>556,'4'=>556,'5'=>556,'6'=>556,'7'=>556,'8'=>556,'9'=>556,':'=>278,';'=>278,'<'=>584,'='=>584,'>'=>584,'?'=>556,
			'@'=>1015,'A'=>667,'B'=>667,'C'=>722,'D'=>722,'E'=>667,'F'=>611,'G'=>778,'H'=>722,'I'=>278,'J'=>500,'K'=>667,'L'=>556,'M'=>833,'N'=>722,'O'=>778,
			'P'=>667,'Q'=>778,'R'=>722,'S'=>667,'T'=>611,'U'=>722,'V'=>667,'W'=>944,'X'=>667,'Y'=>667,'Z'=>611,'['=>278,'\\'=>278,']'=>278,'^'=>469,'_'=>556,
		...
		'Times-Roman' => array(
			...
			'P'=>556,'Q'=>722,'R'=>667,'S'=>556,'T'=>611,'U'=>722,'V'=>722,'W'=>889,'X'=>722,'Y'=>722,'Z'=>611,'['=>333,'\\'=>278,']'=>333,'^'=>469,'_'=>500,
			'`'=>333,'a'=>444,'b'=>500,'c'=>444,'d'=>500,'e'=>444,'f'=>333,'g'=>500,'h'=>500,'i'=>278,'j'=>278,'k'=>500,'l'=>278,'m'=>778,'n'=>500,'o'=>500,
	...
	$name = $this->_getcorefontname($font, $style);
	if(isset($cw[$name]))
		return $cw[$name];
	return $cw['Helvetica'];
}
